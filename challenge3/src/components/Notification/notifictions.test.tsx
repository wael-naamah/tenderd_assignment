...
describe("Notification component", () => {
  ...
  it("applies the info alert class if type prop is not provided", () => {
    ...
    const parentElement = notificationElement.parentElement;
    expect(parentElement).toHaveClass("alert-info");
  });
  ...
  it('applies the success alert class if type prop is "success"', () => {
    ...
    // eslint-disable-next-line testing-library/no-node-access
    const parentElement = notificationElement.parentElement;
    expect(parentElement).toHaveClass("alert-success");
  });
  ...
  it('applies the danger alert class if type prop is "error"', () => {
    ...
    // eslint-disable-next-line testing-library/no-node-access
    const parentElement = notificationElement.parentElement;
    expect(parentElement).toHaveClass("alert-danger");
  });
  ...
  it('applies the warning alert class if type prop is "caution"', () => {
    ...
    // eslint-disable-next-line testing-library/no-node-access
    const parentElement = notificationElement.parentElement;
    expect(parentElement).toHaveClass("alert-warning");
  });
});
